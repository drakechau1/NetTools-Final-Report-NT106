    ...
    public partial class UCSubnetCalculator : UserControl
    {
        ...
        private void calcul()
        {
            ...
            if (subint == 0)
            {
                ...
                outputbox.Text += "Last Host Address is : 255.255.255.254\n";
            ...
            else if (subint < 8)
            {
                ...
                outputbox.Text += "Last Host Address is : " + bit1temp + ".255.255.254";
                outputbox.Text += "\nBroadcast Address is : " + bit1temp;
            ...
            else if (subint < 16)
            {
                ...
                outputbox.Text += "Last Host Address is : " + bit1int;
                outputbox.Text += "." + bit2temp + ".255.254\n";
            ...
            else if (subint < 24)
            {
                ...
                outputbox.Text += "Last Host Address is : " + bit1int + "." + bit2int;
                outputbox.Text += "." + bit3temp + ".254\n";
            ...
            else if (subint < 32)
            {
                ...
                int bit4last = bit4temp - 1;
                outputbox.Text += "Last Host Address is : " + bit1int + "." + bit2int;
                outputbox.Text += "." + bit3int + "." + bit4last + "\n";
                outputbox.Text += "Broadcast Address is : " + bit1int + "." + bit2int;
